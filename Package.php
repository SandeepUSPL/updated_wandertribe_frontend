...
<head>
    <title>Wandertribe Package</title>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1084px)" href="css/Package.css">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 601px) and (max-width: 1083px)" href="css/Package600up.css">
    <link rel="stylesheet" type="text/css" media="screen and (max-width: 600px)" href="css/Package600down.css">
...
<body>
    ...
    <div class="trek-pagination">
        <h2>Treks > Himachal > Kasol Trek > <span>Package Details</span></h2>
    </div>

    <div class="packProgress">
        <div>
            <div id="circle1"></div>
            <hr>
            <div id="circle2"></div>
        ...
        <div class="row">
            <div class="col-sm-4" style="padding: 0;">
                <h3 style="opacity: 1;">Package details</h3>
            </div>
            <div class="col-sm-4">
                <h3 style="text-align: center;">Traveller Information</h3>
            </div>
            <div class="col-sm-4">
                <h3>Payment</h3>
            </div>
    ...
    <div class="row packDetail">
        ...
        <!-- <div class="col-sm-3 form-query">
			<div>
				<form>
					<div class="input-group">
						<input type="text" name="chooseDate" id="dateChosen" placeholder="Choose your date">
					</div>
					<div class="input-group">
						<span>Adult</span>
						<img src="icons/plus-circle.png" id="plusCircle">
						<input type="text" name="noOfPeople" id="people" placeholder="0">
						<img src="icons/minus-circle.png" id="minusCircle">
					</div>
        ...
        <div class="col-sm-8 packPlace">
            <h1></h1>

            <div class="row">
                <div class="col-xs-3 weather1">
            ...
            <div class="accomodation">
                <h3>Accommodation with Activities</h3>

                <div class="row">
                    <div class="col-xs-4">
                        <h4>Camping with Meals and Activities</h4>
                    </div>
                    <div class="col-xs-5">
                        <h4>Price break down</h4>
                        <h4 style="font-weight: 600; margin-top: 25px;" id="price-breakdown"></h4>
                    </div>
                    <div class="col-xs-3">
                        <h4>Total Price</h4>
                        <h4 style="font-weight: 600; margin-top: 25px;" id="total-price"></h4>
                    </div>
                </div>
...
<script>
    // $('body').click(function() {
    //     $('.packPlace button').css('background-color', '#540a05');
    //     $('.packPlace button').css('opacity', 0.2);
    //     setTimeout(function() {
    //         $('.packPlace button').css({
    ...
    $('#plusCircle').click(function(event) {
        var val = $('#people').attr('placeholder');
        var num = Number(val) + 1;
        val = String(num);
        document.getElementById("people").placeholder = val;
    })

    $('#minusCircle').click(function(event) {
        if ($('#people').attr('placeholder') > 0) {
            document.getElementById("people").placeholder =
                String(Number($('#people').attr('placeholder')) - 1);
        }
    })
</script>
