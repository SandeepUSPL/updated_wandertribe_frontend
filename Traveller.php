...
<head>
    <title>Wandertribe Traveller</title>
    ...
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1084px)" href="css/Traveller.css">

    <link rel="stylesheet" type="text/css" media="screen and (min-width: 601px) and (max-width: 1083px)"
        href="css/Traveller600up.css">
    <link rel="stylesheet" type="text/css" media="screen and (max-width: 600px)" href="css/Traveller600up.css">
...
<body>
    ...
    <div class="trek-pagination">
        <h2>Treks > Himachal > Kasol Trek > Package Details > <span>Traveller Information</span></h2>
    </div>
    ...
    <div class="row travelInfo">
        <div class="col-sm-5">
            <h1></h1>
            <div class="row" style="margin: 5px 0 18px 0;">
                <h3 class="col-xs-4">4 Days</h3>
                <h3 class="col-xs-6">3 Nights</h3>
            </div>
            <h3></h3>
            <h3 style="color: #FF5700; margin-bottom: 20px;"></h3>
            <h5>Have Any Question?</h5>
            <h5>Contact us @</h5>
            <h4>+91-9872-129281</h4>
        </div>

        <div class="col-sm-5 col-sm-offset-1 contactInfo">
            <h2>Contact Information</h2>
            <h6>Book with your social accounts</h6>

            <div>
                <a href="https://api.wandertribe.in/socialMediaRedirect/google">
                    <img src="new_img/login/google.png">
                </a>
                <p>OR</p>
                <a href="https://api.wandertribe.in/socialMediaRedirect/facebook">
                    <img src="new_img/login/fb.png">
                </a>
            </div>
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="travellerName">
                </div>
                <div class="form-group">
                    <label>Email id</label>
                    <input type="text" class="form-control" name="travellerEmail">
                </div>
                <div class="form-group">
                    <label>Mobile number</label>
                    <input type="text" class="form-control" name="travellerMobile">
                </div>
