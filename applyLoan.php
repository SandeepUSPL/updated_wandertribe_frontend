...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-149144948-1"></script>
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 1084px)" href="css/applyLoan.css">
    <link rel="stylesheet" type="text/css" media="screen and (min-width: 601px) and (max-width: 1083px)"
        href="css/applyLoan600up.css">
    <link rel="stylesheet" type="text/css" media="screen and (max-width: 600px)" href="css/applyLoan600up.css">
...
<body>
    ...
    <div style="position: relative;">
        <img class="hero-image" src="new_img/loan/loan.png" alt="">
    ...
    <div class="loan-form">
        <div class="row fill" style="margin: 0;">
            <h1 class="col-xs-8">Fill this form to apply loan</h1>
            <figure class="col-xs-4 upload">
                <img src="new_img/loan/loan-upload-photo.png" alt="">
                <!-- <figcaption>UPLOAD PASSPORT SIZE PHOTO</figcaption> -->
                <div class="input-group" style="margin-top: 5px;">
                    <span class="input-group-btn">
                        <label class="btn btn-primary btn-file" for="photo_input_group">
                            <div class="input required">
                                <input id="photo_input_group" type="file" onchange="readURL(this);" accept="image/*">
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <input type="text" name="loan-name" class="form-control" placeholder="Enter full name">
            </div>

            <div class="row">
                <div class="form-group col-xs-6">
                    <label>Email</label>
                    <input type="email" name="loan-email" class="form-control" placeholder="example@email.com">
                </div>
                <div class="form-group col-xs-6">
                    <label>Mobile number</label>
                    <input type="number" name="loan-mobile" class="form-control" placeholder="Enter Mobile Number">
                </div>
            </div>

            <div class="row">
                <div class="form-group col-xs-6 address">
                    <label>Address</label>
                    <input type="text" name="" class="form-control" placeholder="Building number, street, landmark">
                ...
                <div class="form-group col-xs-6 upload">
                    <!-- <input type="text" name="" class="form-control" placeholder="Upload Address Proof"> -->
                    <div class="input-group">
                        <span class="input-group-btn">
                            <label class="btn btn-primary btn-file" for="address_input_group">
                                <div class="input required">
                                    <input id="address_input_group" type="file" accept="application/pdf">
                                </div>Upload Address Proof
                            </label>
                        </span>
                        <span class="file-input-label"></span>
                        <button class="address-reset">reset</button>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                <label>PAN</label>
                <input type="text" name="pan-no" class="form-control" placeholder="Enter PAN card number">
            </div>

            <div class="row">
                <div class="form-group col-xs-6">
                    <label>Aadhaar card number</label>
                    <input type="number" name="aadhaar-no" class="form-control" placeholder="0000 0000 0000 0000">
                </div>
                <div class="form-group col-xs-6 upload">
                    <!-- <input type="text" name="" class="form-control" placeholder="Upload scan copy"> -->
                    <div class="input-group">
                        <span class="input-group-btn">
                            <label class="btn btn-primary btn-file" for="scan_input_group">
                                <div class="input required">
                                    <input id="scan_input_group" type="file" accept="application/pdf">
                                </div>Upload scan copy
                            </label>
                        </span>
                        <span class="file-input-label"></span>
                        <button class="scan-reset">reset</button>
                    </div>
                </div>
            </div>

            <h3>Type of Loan Amount available</h3>
            <h4><span style="margin-left: 0;">1. </span>Booking amount<span>2. </span>Booking amount + GST<span>3.
                </span>Other</h4>

            <div class="form-group">
                <label>Required loan amount</label>
                <input type="" name="loan-amount" class="form-control" placeholder="0000000">
            </div>

            <div class="form-group" style="width: 100%;">
                <h3>EMI Option you want to apply</h3>
                <input type="radio" name="emiOption" value="Annual">
                <label for="Annual">Annual</label>
                <input type="radio" name="emiOption" value="Semi yearly">
                <label for="Semi yearly">Semi yearly</label>
                <input type="radio" name="emiOption" value="Quarterly">
                <label for="Quarterly">Quarterly</label>
                <input type="radio" name="emiOption" value="Monthly">
            ...
            <div class="form-group">
                ...
                <input type="text" name="bank-holder" class="form-control" placeholder="Enter Account holder Name">
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-6">
                    <label>Branch</label>
                    <input type="text" name="bank-branch" class="form-control" placeholder="Enter branch name">
                </div>
            </div>

            <div class="form-group">
                <label>Account number</label>
                <input type="number" name="account-no" class="form-control" placeholder="Account number">
            </div>

            <div class="form-group">
                <label>Confirm account number</label>
                <input type="number" name="confirm-account-no" class="form-control"
                    placeholder="Confirm Account Number">
            </div>

            <div class="form-group">
                <label>IFSC code</label>
                <input type="text" name="ifsc-code" class="form-control" placeholder="Enter IFSC code">
            </div>

            <div class="form-group bank-address">
            ...
            <div class="form-group upload" style="width: 70%;">
                <!-- <input type="text" name="" class="form-control" placeholder="Upload bank statement or Income proof"> -->
                <div class="input-group">
                    <span class="input-group-btn">
                        <label class="btn btn-primary btn-file" for="statement_input_group">
                            <div class="input required">
                                <input id="statement_input_group" type="file" accept="application/pdf">
                            </div>Upload bank statement or Income proof
                        </label>
                    </span>
                    <span class="file-input-label"></span>
                    <button class="statement-reset">reset</button>
                </div>
            </div>
            ...
            <div class="row" style="margin: 0;">
                <button type="submit" class="col-xs-3 btn btn-success">Submit</button>
            </div>
        </form>
