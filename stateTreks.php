...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen and (min-width: 1084px)" href="css/stateTreks.css">
	<link rel="stylesheet" type="text/css" media="screen and (min-width: 601px) and (max-width: 1083px)" href="css/stateTreks600up.css">
	<link rel="stylesheet" type="text/css" media="screen and (max-width: 600px)" href="css/stateTreks600down.css">
...
<body>
			...
			<div class="col-md-6" style="height: 100%;">
				<div class="row" style="height: 100%;">
					...
					<div class="col-xs-8 col-xs-offset-1 filter-price">
						<span>Price</span>
						<button onclick="asc()">Low-High</button>
						<button onclick="desc()">High-Low</button>
					</div>
				</div>
			</div>
    ...
    <!--footer ends-->
	<script type="text/javascript" src="js/stateTreks.js"></script>
